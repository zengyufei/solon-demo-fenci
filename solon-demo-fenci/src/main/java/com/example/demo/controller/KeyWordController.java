...
public class KeyWordController {
    ...
    public String find(String text, String keyword, String showLabel) {
        ...
        final Map<String, Integer> lastIndexMap = new HashMap<>();
        ...
        for (int i = 1; i < wordEntities.size(); i++) {
            ...
            if (StrUtil.equals(showLabel, "1")) {
                sb.append(beforeWordEntity.getWord());
            }
            sb.append(StrUtil.trim(text.substring(beforeWordEntity.getEndPosition(), nextWordEntity.getBeginPosition())));
            sb.append("\n");
        }
